...
.curl-request
include::{snippets}/auth/refreshToken_fail/tokenType/curl-request.adoc[]

.http-request
include::{snippets}/auth/refreshToken_fail/tokenType/http-request.adoc[]

.http-response
include::{snippets}/auth/refreshToken_fail/tokenType/http-response.adoc[]

.request-body
include::{snippets}/auth/refreshToken_fail/tokenType/request-body.adoc[]

.response-body
include::{snippets}/auth/refreshToken_fail/tokenType/response-body.adoc[]

.request-fields
include::{snippets}/auth/refreshToken_fail/tokenType/request-fields.adoc[]

.response-fields
include::{snippets}/auth/refreshToken_fail/tokenType/response-fields.adoc[]

==== 실패, 유효하지 않은 리프레시 토큰

.curl-request
include::{snippets}/auth/refreshToken_fail/refreshToken/curl-request.adoc[]

.http-request
include::{snippets}/auth/refreshToken_fail/refreshToken/http-request.adoc[]

.http-response
include::{snippets}/auth/refreshToken_fail/refreshToken/http-response.adoc[]

.request-body
include::{snippets}/auth/refreshToken_fail/refreshToken/request-body.adoc[]

.response-body
include::{snippets}/auth/refreshToken_fail/refreshToken/response-body.adoc[]

.request-fields
include::{snippets}/auth/refreshToken_fail/refreshToken/request-fields.adoc[]

.response-fields
include::{snippets}/auth/refreshToken_fail/refreshToken/response-fields.adoc[]
